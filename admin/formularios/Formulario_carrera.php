...
<html>
    <head>
        ...
        <title>Nueva Carrera - WebCampus UNIMAR</title>
            ...
            <div id="Cuadro">
                <form action="../../admin/datos.php" method="POST" autocomplete="off">
                    <table>
                        <tr>
                            <td class="izq">
                                CODIGO CARRERA</td><td class="der"><input type="text" name="codigo" class="Input"></td></tr>
                        <tr>
                            <td class="izq">
                                U.C. TOTALES</td><td class="der"><input type="text" name="unidades" class="Input"></td></tr>
                        <tr>
                            <td class="izq">
                                NÚMERO DE TRIMESTRES</td><td class="der"><input type="text" name="numero" class="Input"></td></tr>
                        <tr>
                            <td class="izq">
                                NOMBRE CARRERA</td><td class="der"><input type="text" name="nombre" class="Input"></td></tr>
                        <tr><td id="C_Bot" colspan="2"><p id="bot"><input type="submit" name="newCarrera" value="Enviar" class="boton"></p></td></tr>
                    </table>
                </form>
            </div>
        </main>
